...
function PaymentGameWin( )
{
    ...
    try {
        ...
        if (allGames.afcChampionshipGames[0].winner === 1) {
            spanColorA16 = "red";
        }
        if (allGames.afcChampionshipGames[0].winner === 2) {
            spanColorA26 = "red";
        }
        if (allGames.nfcChampionshipGames[0].winner === 1) {
            spanColorN17 = "red";
        }
        if (allGames.nfcChampionshipGames[0].winner === 2) {
            spanColorN27 = "red";
        }
    } catch (err) { }
    ...
    return (
        <main id="playoff-bracket-entry">
            ...
            <div>Line 1 - <span id={spanColorA11}>2</span><span id={spanColorA12}>3</span><span id={spanColorA13}>4</span> <span id={spanColorN11}>2</span><span id={spanColorN12}>3</span><span id={spanColorN13}>4</span> <span id={spanColorA14}>1</span><span id={spanColorA15}>M</span> <span id={spanColorN14}>1</span><span id={spanColorN15}>M</span> <span id={spanColorA16}>H</span> <span id={spanColorN17}>H</span> A</div>
            <div>Line 2 - <span id={spanColorA21}>7</span><span id={spanColorA22}>6</span><span id={spanColorA23}>5</span> <span id={spanColorN21}>7</span><span id={spanColorN22}>6</span><span id={spanColorN23}>5</span> <span id={spanColorA24}>L</span><span id={spanColorA25}>m</span> <span id={spanColorN24}>L</span><span id={spanColorN25}>m</span> <span id={spanColorA26}>L</span> <span id={spanColorN27}>L</span> N</div>
